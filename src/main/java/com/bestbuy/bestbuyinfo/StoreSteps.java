...
import com.bestbuy.constants.StoresPath;
...
public class StoreSteps {
    ...
    public HashMap<String, Object> getStoreInfoByStoreName(int storeID) {
        return SerenityRest.given().log().all()
                ...
                .get(StoresPath.STORES + EndPoints.GET_SINGLE_Store_BY_ID)
                .then()
                .statusCode(200)
                .extract().path("");
    }
    ...
    public ValidatableResponse updateStore(
        ...
        return SerenityRest.given().log().all()
                ...
                .when()
                .body(storePojo)
                .patch(StoresPath.STORES + EndPoints.UPDATE_Store_BY_ID)
    ...
    public ValidatableResponse deleteStore(int storeID) {
        return SerenityRest.given().log().all()
                .pathParam("storeID", storeID)
                .when()
                .delete(StoresPath.STORES + EndPoints.DELETE_Store_BY_ID)
                .then().log().all().statusCode(200);
    }
