...
public class ProductsSteps  extends ProductPojo{
    ...
    public HashMap<String, Object> getProductInfoByProductName(int productID) {
        return SerenityRest.given().log().all()
                ...
                .get(ProductsPath.PRODUCTS + EndPoints.GET_SINGLE_Product_BY_ID)
                .then()
                .statusCode(200)
                .extract().path("");
    }
    ...
    public ValidatableResponse updateProduct(
        ...
        return SerenityRest.given().log().all()
                ...
                .when()
                //.body(productPojo)
                .patch(ProductsPath.PRODUCTS + EndPoints.UPDATE_Product_BY_ID)
    ...
    public ValidatableResponse deleteProduct(int productID) {
        return SerenityRest.given().log().all()
                .pathParam("productID", productID)
                .when()
                .delete(ProductsPath.PRODUCTS + EndPoints.DELETE_Product_BY_ID)
                .then().log().all().statusCode(200);
    }
